...
describe('Cross-Chain Trust Sync: Secondary Requests from Primary', () => {
  ...
  it('should handle request for unknown DID gracefully', async () => {
    const unknownDid = 'did:agentmesh:base:0x0000000000000000000000000000000000000000';
...
describe('Cross-Chain Trust Sync: Multi-Agent Batch Sync', () => {
  ...
  const agents = [
    { did: 'did:agentmesh:base:0x1111111111111111111111111111111111111111', score: 9500 },
    { did: 'did:agentmesh:base:0x2222222222222222222222222222222222222222', score: 8000 },
    { did: 'did:agentmesh:base:0x3333333333333333333333333333333333333333', score: 7500 },
    { did: 'did:agentmesh:base:0x4444444444444444444444444444444444444444', score: 6000 },
  ];
