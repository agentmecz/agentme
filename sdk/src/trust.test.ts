 ...
 */
function createMockClient(options: { connected?: boolean } = {}): AgentMeshClient {
...
describe('TrustClient', () => {
  ...
  describe('getTrustScore()', () => {
    it('should throw error when client not connected', async () => {
      ...
      await expect(
        disconnectedTrust.getTrustScore('did:agentmesh:base:agent1')
    ...
    it('should return normalized trust scores', async () => {
      ...
      const score = await trust.getTrustScore('did:agentmesh:base:agent1');
    ...
    it('should hash DID and call contract', async () => {
      ...
      await trust.getTrustScore('did:agentmesh:base:agent1');
  ...
  describe('getTrustDetails()', () => {
    it('should fetch all trust data in parallel', async () => {
      ...
      const details = await trust.getTrustDetails('did:agentmesh:base:agent1');
    ...
    it('should calculate success rate correctly', async () => {
      ...
      const details = await trust.getTrustDetails('did:agentmesh:base:newagent');
  ...
  describe('getReputation()', () => {
    it('should return reputation data', async () => {
      ...
      const reputation = await trust.getReputation('did:agentmesh:base:agent1');
  ...
  describe('getEndorsements()', () => {
    it('should return endorsement array', async () => {
      ...
      const endorsements = await trust.getEndorsements('did:agentmesh:base:agent1');
    ...
    it('should return empty array for agent with no endorsements', async () => {
      ...
      const endorsements = await trust.getEndorsements('did:agentmesh:base:newagent');
  ...
  describe('trust score validation', () => {
    it('should handle zero scores', async () => {
      ...
      const score = await trust.getTrustScore('did:agentmesh:base:newagent');
    ...
    it('should handle maximum scores', async () => {
      ...
      const score = await trust.getTrustScore('did:agentmesh:base:perfectagent');
  ...
  describe('error handling', () => {
    it('should throw when trustRegistry not configured', async () => {
      ...
      await expect(trust.getTrustScore('did:agentmesh:base:agent1')).rejects.toThrow(
  ...
  describe('endorsement graph traversal', () => {
    it('should support multiple endorsers for an agent', async () => {
      ...
      const result = await trust.getEndorsements('did:agentmesh:base:agent1');
