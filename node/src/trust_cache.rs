//! Trust score caching for AgentMesh.
//!
...
//!
//! ```rust,ignore
//! use agentmesh_node::trust_cache::{TrustCache, TrustCacheConfig};
//!
//! let cache = TrustCache::new(TrustCacheConfig::default());
//!
//! // Get or load trust score
//! let score = cache.get_or_load("did:agentmesh:base:agent1", || async {
