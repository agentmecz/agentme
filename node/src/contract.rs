...
mod tests {
    ...
    fn test_did_to_hash_produces_consistent_output() {
        let did = "did:agentmesh:base:test-agent";
    ...
    fn test_did_to_hash_different_dids_produce_different_hashes() {
        let hash1 = TrustRegistryClient::did_to_hash("did:agentmesh:base:agent1");
        let hash2 = TrustRegistryClient::did_to_hash("did:agentmesh:base:agent2");
    ...
    fn test_did_hash_is_32_bytes() {
        let hash = TrustRegistryClient::did_to_hash("did:agentmesh:base:test");
