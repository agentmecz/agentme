...
//!
//! ```rust,ignore
//! use agentmesh_node::events::{EventListener, EventListenerConfig, ContractEvent};
//!
...
/// Contract events emitted by AgentMesh smart contracts.
#[derive(Debug, Clone)]
...
/// Real-time event listener for AgentMesh contracts.
///
